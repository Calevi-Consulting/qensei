...
> (see [`../contract.md`](../contract.md)) normalizes this file to
...
- [type: spec] [SHOP-456 — bulk discount spec](../../core/specs/SHOP-456-bulk-discount.md)
- [type: learnings] [Off-by-one threshold sites](../../sut/mock-shop/learnings/SHOP_LEARNINGS.md)
- [type: related] [SHOP-123 — cart total](../../core/specs/SHOP-123-cart-total.md)
